...
- Work effectively with *The Guardian* REST API and the YouTube Data API.
...
You can obtain your API keys by registering on *The Guardian*'s website. The process is outlined on their [developer page](open-platform.theguardian.com/documentation/). We won't review all the steps here, as they can easily change and result in confusion. However, the process is straightforward and well-explained.
