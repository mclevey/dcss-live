...
@fig-20_02 below is a sketch of the types of models that are widely-used within the symbolic, probabilistic, and connectionist paradigms. Below, we will consider the "learning" analogies that inform these various different models to build an intuition of how they work, and how they relate to one another. 
