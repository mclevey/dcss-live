...
@fig-13_02 below further clarifies the relationships between these three matrices. 

![](figures/svd.png){#fig-13_02}
...
To make this a bit easier, we can transpose the `lsa.components_` matrix (`V` @fig-13_02) to create a dataframe where the rows are terms in the vocabulary and each column represents one of the latent dimensions. The score in each cell tells you how strongly associated that word is for the given topic.
